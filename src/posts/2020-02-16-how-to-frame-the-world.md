...
In order to determine the value of something, we need to anchor it to some value. You can see this most blatantly in the form of super market ads, where they may have products at inflated prices with steep discounts and say they're "on sale". Your mind determines that this price is the "real value" of the item and that you are getting a discount, so this must be a good deal.

We use anchoring in many other ways. I'm most interested in anchoring and its effects on social interaction and quality of life.

Consider this. Before the Enlightenment, who was spouting off about rights? No one had rights to literally anything. Everything was considered a privilege. Only by achieving some form of consensus, were they able to agree that everyone had some actions and abilities that could not be taken away or violated. In this sense, they created a higher baseline, they anchored the rights of individuals at a certain point.

What makes this all a stroke of genius is that we've turned this into literal religion. We set a hard fence, saying the buck stops here, we will not surpass this point. We mythologized this into a document that we can pretty much never amend or change, enshrining it not just into our nation's history, but into it's ethos.

Now consider social media. Real life social interaction is anchored by some sense of politeness or respect for whoever you're talking to. The person you're talking to is literally in front of you, and so you can more easily visualize what sort of effect something you might say might have on said person. You can more easily read that person's responses. You are also more accountable for what you say. If you're not in a group interaction, you are more likely to engage in a more serious attempt at discourse, and even if you are in a group, chances are that this group is less polarized that whatever internet clique you associate yourself with. There are still mechanisms that ensure this baseline.

The baseline for social media is absolutely terrible. The only thing required is the ability to spur on some form of emotion. Emotion increases virality. The friction involved in doing such low-effort posts or dumping is much less than some form of thoughtful interaction. Furthermore, as we are more naturally inclined to react or make decisions based off emotion rather than reason, we are already biased towards this form of emotional manipulation.

Some may argue that the answer for this is moderation, but this is ignorant of the fact that at scale, weird things happen. Large public squares like Facebook are larger than governments and don't have the centralized consensus that the founders had when they agreed on a set of rights. They are more likely to be eclipsed by a platform that does not require something like that, as we are seeing in terms on the global level with the United States and China. The United States offers economic aid, but with strings attached. Human rights records need to be improved. X and Y condition have to be met. China has much less strings. And thus, we come to the conclusion that anchoring or the baseline is set by the weakest point. If some country is willing to use child labor to churn out fast fashion, it sets the bar for everyone else in a very sad race to the bottom.

The way around this bar-setting is branding. Branding ignores the baseline because it creates an individualistic independent identity for itself. You get a sense of what the company believes or stands for.

A more important question in terms of the baseline is our deficits, which will be explored in much more detail in the truly liquid markets section.
...
As much as journalists claim that they seek the truth and objectivity, journalism has become a product so this narrative monopoly does not satisfy everyone. In the age of social media, we see sites spring up to meet literally every ideological view or way of thinking. Platforms like Facebook and Twitter significantly reduced the friction involved in sharing information, especially emotionally-charged information. This has made it easy for things like fake news to proliferate. It has also created a toxic atmosphere where everyone is so emotionally-charged. The keyboard warrior is perhaps the best example of this, so engrossed in whatever drama is on social media, furiously pumping out hot takes and ironic statements. People are abstracted from the results of their actions and are increasingly not seeking to engage with people they disagree with, but perform and mock said person in front of their audience.

Journalism has fallen by the sword of postmodernism whereby they've deconstructed literally everything that the only way forward is nihilism. Institutions deserve a check and should require accountability, but ironically the people who are supposed to hold them accountable, journalists, often don't hold themselves accountable. Fredrik De Boer had an excellent post on this (which he later deleted) called the irresistible force vs. the ironized object. When the media refuses to engage with it's critics, and instead labels them as Big \[whatever\] (which can be true, but doesn't necessarily engage with said criticism) or alt-right, it only increases the number of people who feel alienated by the surrounding media apparatus.
...
The solution I have towards this is probably something along the lines of just getting rid of for-profit national media altogether. Non-profit outlets like ProPublica do a much better job of reporting anyways. They get national stories by threading local stories together. Something like NPR also does fine. Social media also needs to drastically change to promote longform thought and kind disagreement. If everyone agrees that they want to understand something, disagreement becomes much more easier. I understand that this approach is not conducive to growth, but social media has literally become a cancer, an unconstrained growth. It should, however, result in a fairly long-lasting community, I believe. You can find more about that in my post about recommender systems and content curation.

One concern here is of course, centralization, and the government. If we let the government control the media, are we not enabling straight-up propaganda? Media clearly needs to be supported so who funds it? This is a good reason for Universal Basic Income (UBI), but I digress. We don't necessarily have to have the government fund it, if we as individuals are empowered to do so.
...
As the number of people on social media platforms like Facebook and Twitter eclipse the population of governments, there have been growing calls for Facebook and Twitter to enforce stricter moderation. If Germany can unilaterally ban nazism and all its sympathizers, why can't Facebook ban the alt-right people?

The problem is that of boundaries. There's a fine line between setting a boundary and creating a feedback loop. The slippery slope fallacy is a fallacy in that you can't assume that something will automatically lead to another thing, but this doesn't mean that this thing doesn't cause a _higher probability_ of the other thing occurring. If Facebook were to start doing this, as Twitter has, there's no limit on what sort of chilling effect that could happen. The only boundary here would be societal consensus (murder is a universally bad thing!), but consensus is a hard thing to achieve. If when Facebook was founded, they agreed on a consensus view to moderate and deny the platform to eugenicists and their ilk, then it'd be perfectly fine. Right now, Facebook and Twitter get huge blowback for perceived censorship (rightly or wrongly, idk), but if society chooses not to care about a thing (you can only focus your energy on so many things after all), they can move towards defining the window of discourse. One could imagine how this could be problematic given tech's almost unilateral control over social communications. I can't find the tweet, but it expressed that a significant number of people (including I) don't know what's happening 5 blocks around them, but do know whatever's happening in Washington. If everybody has a free protocol (speaking to one another), but no one uses it, it no longer becomes a viable choice. Moderated forms of communication become the only option. This is not necessarily a bad thing, but is a fine line to cross. We can probably agree that there are people who universally make the discourse worse (looking at you Caltrain flat-earther guy), but tribalism is bound to provoke unsolicited attacks on banning one another. You can imagine an America where the government is still in place with all it's civil liberties and everything, but no one can really exercise them, because all social interaction is done through the Internet, with ingrained censorship. 
...
We need to consider what exactly is money. Is money some physical thing that we want in it of itself? Or is it something that functions as a proxy for the things that we want?
...
If the money is printed by the government to pay it's debts, as [Zimbabwe did](https://en.wikipedia.org/wiki/Hyperinflation_in_Zimbabwe), it lowers the credit rating for the currency and causes inflation. Since the world is pretty global and interdependent, this means that relative to other currencies, Zimbabwe's dollar loses value. This can be solved by one centralized currency for the entirety of a system. Like a search engine, or like electricity, money may need to be viewed in the future as a utility. We explore this more in the case for utilities.

The last concern is that of demand and supply. If the amount of people who want something is greater than the amount of that item, there is no possible way to satisfy all of them. I argue in the next section, that we have the capacity and resources to make this happen. The mindset of scarcity should not exist when we have turned the world into one of abundance.

### demand and supply

Traditional logic states that if demand exceeds supply, costs should go up until demand levels off. This is also true of the opposite case. Utilities ignore this, because they set a minimum floor on demand for something irrespective of price or other factors. 

### the case for utilities

What utilities are we talking about here? I'd argue that we need utilities for all deficits. This means food, water, electricity, healthcare, social communication (no man is an island), housing, and the ultimate proxy for all of this, money.

We've made significant progress in the idea space by agreeing on a uniform consensus regarding rights to free speech and other civil liberties. But we've ignored our physical bodies.

As I argued earlier, people in war zones do not get sheltered free time to explore what's possible. They're too busy trying to survive. The result is we lose out on an incredible number of people, the could-be-Einsteins or could-be-Curies, or just generally productive members of society.

Our world is abundant. We have the resources to [feed everyone](https://www.weforum.org/agenda/2016/07/the-world-produces-enough-food-to-feed-everyone-so-why-do-people-go-hungry). We have [people who want to build more housing](https://www.theatlantic.com/business/archive/2017/07/yimby-groups-pro-development/532437/). We have a [uniform Internet grid](https://en.wikipedia.org/wiki/Internet_backbone). Many countries already have a [universal system of healthcare](https://en.wikipedia.org/wiki/List_of_countries_with_universal_health_care). 

Just like the 4-minute mile, people have already demonstrated that this is possible. What we need is the will to do so.
