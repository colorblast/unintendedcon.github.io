      ...
      <section className="flex flex-col md:flex-row items-center">
        <div className="w-full text-gray-900">
          ...
          <cite className="font-bold mt-4 text-xs uppercase block">
            <a href="https://en.wikipedia.org/wiki/The_Politician_(TV_series)">
              – River, The Politician
            </a>
          </cite>
          <hr className="opacity-25" />
          <br />
          <h2 className="text-3xl">Goals for 2020</h2>
          <p>
            For the first time, I'm making my goals public in order to stay more
            accountable. Consider it an experiment, if you will.
          </p>
          <br />
          <ul className="list-disc">
            ...
            <li>
              Build a{" "}
              <a className="text-gray-900" href="https://getmakerlog.com">
                makerlog
              </a>{" "}
              streak of at least 30 days
            </li>
            <li>
              Meet at least 3 new interesting people per month. (I'm an{" "}
              <a
                className="text-gray-900"
                href="https://en.wikipedia.org/wiki/Big_Five_personality_traits"
              >
                INFP-T / INTP personality
              </a>
              , which means I'm an introvert).
            </li>
            <li>Bike twice a week, weather permitting</li>
            <li>
              Do something outside of my comfort zone before the semester ends
            </li>
          </ul>
        </div>
      </section>
