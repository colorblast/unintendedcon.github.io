    ...
    <Layout>
      ...
      <section>
        <div className="leading-loose text-gray-800">
          ...
          <p>
            Before I worked on Banh, I spent a decent chunk of my time doing{" "}
            <a
              className="font-bold no-underline text-gray-900"
          ...
          <p>
            My broad interests are productivity, urbanism, transit systems, and
            increased innovation potential. My more niche research interests are
            in cognition and category learning (self-supervised).
          </p>
          <p>
            Besides CS and making, I enjoy biking, long walks, longform, and
            practical philosophy. You can hit me up on{` `}
            <a
              className="font-bold no-underline text-gray-900"
